...
Step-1: Open 2 terminal separately into vscode. 
Step-2: RUN "node app.js" in one terminal
Step-3: RUN "node .\bin\client.js" on separate terminal.
Step-4: Observe logs on encrypted and decrypted messages on terminal. and also into db.